...
class NotFound extends React.Component {
  ...
  <p className="intro__subhead">You... you can't have that.</p>
</header>
...
<section id="lemmehaveit" className="lemmehaveit">
  <div id="cupcake-canvas" className="cupcake-canvas">
    <div className="cupcake-svg-container">
      <svg id="cupcake-svg" className="cupcake-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 594 289">
        <g fill="none" fill-rule="evenodd">
          <g id="cupcake-cupcake-cupcake" className="cupcake-cupcake-cupcake" transform="translate(221 147)">
          ...
          <rect id="cupcake-box" className="cupcake-box"width="230" height="170" fill="#A78C84" transform="translate(182 119)"/>
        </g>
      </svg>
    </div>
  </div>
